...
public:
    ...
    TEST_METHOD(CX_W_MediaProcessor2D_Rotate)
    {
        ...
        auto processor = ref new ImageProcessor();
        ...
        Await(ImageEncoder::SaveToFileAsync(sampleRotated, file, ImageCompression::Jpeg));
    ...
    TEST_METHOD(CX_W_MediaProcessor2D_Convert)
    {
        ...
        Await(ImageEncoder::SaveToFileAsync(sampleConverted, file, ImageCompression::Jpeg));
        Log() << L"Saved " << file->Path->Data();
